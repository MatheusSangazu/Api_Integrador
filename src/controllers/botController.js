...
// Função para obter todos os inscritos passando por todas as páginas de contato do botConversa
...
// Controlador para obter dados dos inscritos. Pega Dados da função fetchAllSubscribers
